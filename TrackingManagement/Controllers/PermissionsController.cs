...
namespace TrackingManagement.Controllers
{
    ...
    public class PermissionsController : ControllerBase
    {
        ...
        public  IActionResult createScopePermission([FromBody] ScopePermissionCreated scopePermissionCreated)
        {
            ...
            try
            {
                var scope = _permissionService.createScopePermission(scopePermissionCreated,userId);
                transaction.Commit();
        ...
        {
            int userId = (int)HttpContext.Items["UID"];
            var result = await _permissionService.updatePermission(updatedScopePermission,userId);
        ...
        public IActionResult updateScopeAllowedRoute([FromBody] UpdateScopeAllowedRoute updateScopeAllowedRoute)
        {
            ...
            int updateResult = _permissionService.updateScopeAllowedRoute(updateScopeAllowedRoute,userId);

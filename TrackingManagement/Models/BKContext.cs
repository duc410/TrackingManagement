...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Segmentation>(entity =>
            {
                ...
                entity.Property(e => e.EscortId).HasColumnName("Escort_Id");
                ...
                entity.HasOne(d => d.Escort)
                    ...
                    .HasConstraintName("FK__Segmentat__Escort");
            ...
            modelBuilder.Entity<Escort>(entity =>
            {
                ...
                entity.HasOne(d => d.Rfid)
                    .WithMany(p => p.Escorts)
                    .HasForeignKey(d => d.Rfidid)
                    .HasConstraintName("FK__Escort__RFIDI");

                entity.HasOne(d => d.Unit)
                    .WithMany(p => p.Escorts)
                    .HasForeignKey(d => d.UnitId)
                    .HasConstraintName("FK__Escort__UnitI");
            });
            ...
            modelBuilder.Entity<Audit>(entity => 
            {
                ...
                entity.HasOne(e=>e.User)
                      ...
                      .HasConstraintName("FK__Audit_User");
            });
        ...
        private void OnBeforeSaveChanges(int userId)
        {
            ...
            foreach (var entry in ChangeTracker.Entries())
            {
                ...
                auditEntry.TableName = entry.Entity.GetType().Name+"s";

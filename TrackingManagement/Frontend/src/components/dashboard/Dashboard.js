          ...
          >
            <Routes>
              <Route
                path="/"
                element={
                  <ProtectedRoute path={"/"} allowedRoutes={allowedRoutes}>
                    <Home />
                  </ProtectedRoute>
                }
              />
              ...
              <Route
                path="/users"
                element={
                  <ProtectedRoute path={"/users"} allowedRoutes={allowedRoutes}>
                    <User />
                  </ProtectedRoute>
                }
              />
              ...
              <Route
                path="/rfids"
                element={
                  <ProtectedRoute path={"/rfids"} allowedRoutes={allowedRoutes}>
                    <RFID/>
                  </ProtectedRoute>
                }
              />
              <Route
                path="/cars"
                element={
                  <ProtectedRoute path={"/cars"} allowedRoutes={allowedRoutes}>
                    <CarManager />
                  </ProtectedRoute>
                }
              />

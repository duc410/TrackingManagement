...
namespace TrackingManagement.Services
{
    public class PermissionService : IPermissionService
    {
        ...
        public async Task<int> updatePermission(UpdatedScopePermission updatedScopePermission,int userId)
        {
            ...
            return await _db.SaveChangesAsync(userId);
        }
